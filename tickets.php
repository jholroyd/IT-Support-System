...
if(isset($_POST['new_ticket'])){
    ...
    create_ticket($ticket_subject, $ticket_user_id, $ticket_department, $ticket_room, $ticket_message, $ticket_priority, $ticket_category);
}
...
if(isset($_POST['edit_ticket'])) {
	...
	$edit_solution = $_POST['edit_solution'];
    
    edit_ticket($edit_id, $edit_subject, $edit_user_id, $edit_department, $edit_room, $edit_message, $edit_status, $edit_priority, $edit_category, $edit_solution);
    
}

// close ticket.
if(isset($_POST['close_ticket'])) {
	$id = $_POST['close_ticket_id'];
...
// delete ticket reply.
if(isset($_POST['delete_ticket_reply'])) {
	$id = $_POST['ticket_reply_id'];
	
	delete_ticket_reply($id);
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <!-- title -->
    <title><?php if($_SESSION['role'] == 2){ ?>Access Denied<?php } else { ?>Tickets<?php } ?> - Support</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p>Sorry, but the ticket you are trying to access doesn't exist. Use the button below to go back to the tickets page.</p>
                    <a href="tickets.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Go to Tickets</a>
                </div>
            </div>
            <?php } ?>
            <?php } else { ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- panel heading -->
                        <div class="panel-heading">
                            <i class="fa fa-ticket fa-fw"></i> Active Tickets
                            <div class="pull-right">
                                <div class="btn-group">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin table-bordered">
                                    ...
                                    <tbody>
                                        <?php
										$query = $db->prepare('SELECT `id`, `subject`, `category_id`, `user_id`, `room_id`, `status` FROM `tickets` ORDER BY `status`');
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- panel heading -->
                        <div class="panel-heading"><i class="fa fa-ticket fa-fw"></i> Closed Tickets</div>
                        
                        <!-- panel body -->
                        <div class="panel-body">
                            <?php if(closed_tickets_count_return() > 0){ ?>
                            <div class="table-responsive">
                                <table class="table no-margin table-bordered">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
										$query = $db->prepare('SELECT `id`, `subject`, `category_id`, `user_id`, `room_id`, `status` FROM `tickets` WHERE `status` = ? ORDER BY `id`');
                                        $query->bindValue(1, 2);
